...
class shopServiceGodwanController extends Controller
{
    ...
    public function create()
    {
        ...
        $result = Item::with(['unit', 'godown','shopService'])->get(['id', 'item_name', 'item_unit']);
...
if ($godownshop->transfert_from == 'godown') {
    ...
    public function edit($id)
    {
        ...
        return view('stock-transfert.shop-service-to-godown.create', compact('godownshop', 'items', 'units'));
    }
