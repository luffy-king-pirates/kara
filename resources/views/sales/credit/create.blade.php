                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="creation_date" name="creation_date"
                            value="{{ $credit ? $credit->creation_date : \Carbon\Carbon::now()->toDateString() }}" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
            ...
            <div class="row mb-3">
                <div class="col-md-4" id="customer_name_div">
                    <div class="form-group">
                        ...
                        <input id="customer_id" value="{{ $credit ? $credit->customer->customer_id : old('customer_id') }}"
                ...
                <div class="col-md-4" id="vrn_number_div">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="vrn_number"
                            value="{{ $credit ? $credit->customer->customer_vrn : old('customer_vrn') }}" name="vrn_number"
                    ...
                    <tr>
                        ...
                        <th>
                            <input type="number" class="form-control" id="total_amount_table" name="total_amount_table"
                                value="{{ $credit ? $credit->details->sum('total') : 0 }}" disabled>
                        </th>
                    </tr>
                </tfoot>
            </table>
