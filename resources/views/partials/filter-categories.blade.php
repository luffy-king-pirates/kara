<div id="filter-form" class="card mb-3">
    ...
    <div class="card-body">
        <div class="d-flex flex-wrap">
            ...
            <div class="form-group col-md-4 mb-3">
                <label for="filter-categorie-name">Category Name</label>
                <input type="text" id="filter-categorie-name" name="filter-categorie-name" class="form-control" placeholder="Category Name">
            </div>
