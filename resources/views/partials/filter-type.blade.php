<div id="filter-form" class="card mb-3">
    <div class="card-header">
        <h5 class="card-title mb-0">Filter Stock Types</h5>
    </div>
    <div class="card-body">
        <div class="d-flex flex-wrap">
            ...
            <!-- Stock Type Name Filter -->
            <div class="form-group col-md-4 mb-3">
                <label for="filter-stock-type-name">Stock Type Name</label>
                <input type="text" id="filter-stock-type-name" name="filter-stock-type-name" class="form-control"
                    placeholder="Stock Type Name">
            </div>
