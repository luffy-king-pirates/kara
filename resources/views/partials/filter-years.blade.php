<div id="filter-form" class="card mb-3">
    <div class="card-header">
        <h5 class="card-title mb-0">Filter Years</h5>
    </div>
    <div class="card-body">
        <div class="d-flex flex-wrap">
            ...
            <!-- Year Filter -->
            <div class="form-group col-md-4 mb-3">
                <label for="filter-year-name">Year</label>
                <input type="number" id="filter-year-name" name="filter-year-name" class="form-control" placeholder="Year">
            </div>
