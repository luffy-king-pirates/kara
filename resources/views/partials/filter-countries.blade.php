<div id="filter-form" class="card mb-3">
    <div class="card-header">
        <h5 class="card-title mb-0">Filter Countrie</h5>
    </div>
    <div class="card-body">
        <div class="d-flex flex-wrap">
            ...
            <!-- Country Name Filter -->
            <div class="form-group col-md-4 mb-3">
                <label for="filter-country-name">Country Name</label>
                <input type="text" id="filter-country-name" name="filter-country-name" class="form-control" placeholder="Country Name">
            </div>
