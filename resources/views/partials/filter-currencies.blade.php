<div id="filter-form" class="card mb-3">
    <div class="card-header">
        <h5 class="card-title mb-0">Filter Currencies</h5>
    </div>
    <div class="card-body">
        <div class="d-flex flex-wrap">
            ...
            <div class="form-group col-md-4 mb-3">
                <label for="filter-currencie-name">Currency Name</label>
                <input type="text" id="filter-currencie-name" name="filter-currencie-name" class="form-control" placeholder="Currency Name">
            </div>

            <!-- Currency Value Filter -->
            <div class="form-group col-md-4 mb-3">
                <label for="filter-currencie-value">Currency Value</label>
                <input type="number" id="filter-currencie-value" name="filter-currencie-value" class="form-control" placeholder="Currency Value">
            </div>
