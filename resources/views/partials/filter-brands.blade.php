<div id="filter-form" class="card mb-3">
    <div class="card-header">
        <h5 class="card-title mb-0">Filter Brands</h5>
    </div>
    <div class="card-body">
        <div class="d-flex flex-wrap">
            ...
            <!-- Brand Name Filter -->
            <div class="form-group col-md-4 mb-3">
                <label for="filter-brand-name">Brand Name</label>
                <input type="text" id="filter-brand-name" name="filter-brand-name" class="form-control" placeholder="Brand Name">
            </div>
