            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="transfer_from" value="Shop" disabled>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        function addRow() {
            let newRow = `
                <tr>
                    ...
                    <td><input type="text" class="form-control" value="Shop" disabled></td>
        ...
        function initializeAutocomplete(element) {
            $(element).autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    const shopValue = `Shop for ${selectedItem}`;
