...
@section('title', 'Godown to Shop')

@section('content_header')
    <h1>Godown to Shop</h1>
@stop
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="transfer_to" value="Shop" disabled>
                    </div>
                </div>
            </div>
        </form>
        ...
        function initializeAutocomplete(element) {
            $(element).autocomplete({
                ...
                select: function(event, ui) {
                    // Fetch Godown, Shop, and Unit values based on selected item
