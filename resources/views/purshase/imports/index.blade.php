    ...
    <script>
        $(function() {
            ...
            var table = $('#purchase-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('imports.index') }}", // Ensure the correct route for data loading
                    data: function(d) {
                        d.id = $('#filter-id').val();
                        d.import_number = $('#filter-import-number').val();
            ...
            $('#filter-id, #filter-import-number, #filter-supplier, #filter-creation-date, #filter-total-amount')
    ...
    <i class="fas fa-trash-alt"></i> Delete
            ...
            $('#purchase-table tbody').on('click', 'td.dt-control', function() {
                ...
                if (row.child.isShown()) {
                    ...
                    $.get(`/imports/${row.data().id}/details`, function(data) {
            ...
            $('#apply-filter').click(function() {
                ...
                window.open('/export/imports' + queryString, '_blank');
            });
        });
    </script>
    <script>
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            $.ajax({
                url: "{{ route('imports.destroy', '') }}/" + itemId,
                method: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
