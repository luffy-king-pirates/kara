@include('pdf.invoice')
@php
    $totalItems = $credit->details->count();
...
@for ($i = 0; $i < $numIterations; $i++)
    @php
        ...
        $slicedDetails = $credit->details->slice($start, $itemsPerIteration);
                    ...
                    <tr class="h10address">
                        ...
                        <td class="value">
                            @php
                                ...
                                echo \Carbon\Carbon::parse($credit->creation_date)->format('M d, Y');
                            @endphp
                        </td>
                    </tr>
                    <tr class="h10address">
                        ...
                        <td style="font-size: 9pt;width: 30%; text-align: center;font-family:Calibri, sans-serif; border: .5px solid gray;line-height: 20px;"
                            ...
                            <b>TIN NUMBER: {{ $credit->customer->customer_tin }}<br>VRN NUMBER:
                                {{ $credit->customer->customer_vrn }}</b>
                        </td>
                        <td class="label">CREDIT INVOICE #</td>
                        <td class="value">{{ $credit->credit_number }}</td>
                    </tr>
                    <tr class="h10address">
                ...
                <tbody>
                    <tr class="h10details">
                        ...
                        <td colspan="4" class="value-left" style="text-transform: uppercase;">
                            {{ $credit->customer->customer_name }}</td>
                    </tr>
                    <tr class="h10details">
                        <td class="label-left-details">TIN Number</td>
                        <td width="15%" class="text-center"><b>:</b></td>
                        <td colspan="4" class="value-left">{{ $credit->customer->customer_tin }}</td>
                    </tr>
                    <tr class="h10details">
                        <td class="label-left-details">VRN Number</td>
                        <td width="15%" class="text-center"><b>:</b></td>
                        <td colspan="4" class="value-left">{{ $credit->customer->customer_vrn }}</td>
                    </tr>
                </tbody>
            </table>
        @endif
            ...
            <tbody>
                ...
                @if ($end === $totalItems - 1)
                    ...
                    <tr>
                        ...
                        <td class="x6">totla Amout</td>
                        <td class="x3">DISCOUNT 5%</td>
                        <td class="x4" style="text-align: right"><b>total disscount</b></td>
                    </tr>
                    <tr>
                        ...
                        <td class="x6"></td>
                        <td class="x20">TOTAL</td>
                        <td class="x19" style="text-align: right"><b>{{ $credit->total_amount }}</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="x6"></td>
                        <td class="x3">GRAND TOTAL</td>
                        <td class="x19" style="text-align: right"><b>424,795.00</b></td>
                    </tr>
                    <tr>
